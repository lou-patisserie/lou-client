    ...
    <div className=" bg-luoDarkBiege">
      <div className="max-w-[85rem] mx-auto">
        <div className="mx-0 md:mx-4 flex flex-col md:flex-row justify-center items-center md:justify-betwee gap-4 md:gap-10 py-0 md:py-4">
          <div className="max-w-2xl w-full text-slate-100 flex flex-col justify-center py-8 md:py-4 px-4 md:px-0 text-center items-center gap-1">
